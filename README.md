...
- [x] Add new PKG renaming format to prevent renaming error ([TITLE_ID] [CATEGORY] [VERSION] TITLE) (Renaming game and its update PKG with same **IN** the same directory will throw an exception : Cannot create a file when the file already exists.)
